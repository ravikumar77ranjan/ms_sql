--FIRST I will delete all the records from these tables
--NOte that we are delete from the "botttom up" in terms of our hierarchy
DELETE FROM tasks
...
-- Now i am going to "reseed" our identity fields.This will bean uncommon task
-- since we usually don't want to mess with our identity fields/primary keys like this.
--However, since i have just deleted all the data from these tables, i want to reset
--  identity fields so that my insert statementss below don't cause conflicts in the future
--We will use the DBCC (Database Console Commands) command and CHECKIDENT function to reset the identity counter to 1
...
-- ISERT Staements to create our companies
SET IDENTITY_INSERT companies ON
INSERT INTO companies(id, company_name, ceo_name, parent_company_id) VALUES(1,'Data Dweebs, Inc.','Orissa Laurion', NULL)
INSERT ITO companies(id,company_name, ceo_name,parent_company_id) VALUES(2,'SQL Server Consultants, LIC', 'Tyden Teems',1)
INSERT INTO companies(id, company_name, ceo_name,parent_company_id) VALUES(3,'IT Dimensions COnsulting, LIC','Reyansh', NULL)
SET IDENTITY_INSERT companies OFF
-- END Companies INSERTS

-- INSERT statements to create our customers
SET IDENTITY_INSERT customers ON
INSERT INTO customers(id, company_id, customer_name, contact_first_name, contact_last_name, phone_number, address_1, address_2, city, state, zip_code) VALUES(1,1, 'Acme, Ins.', 'Ashton', 'Gallik','245-865-6869','388 S Buffalo Ave','Suite 100', 'Crompton','CA','900234')
INSERT INTO customers(id, company_id, customer_name, contact_first_name, contact_last_name, phone_number, address_1, address_2, city, state, zip_code) VALUES(2,1,'Industrial PRoducts, 'LLC', 'Ivann', 'Mikula','523-699-9728', '797 NE 54th St', 'Suite 205', 'Moorefield', 'WV', '26836')
INSERT INTO customers(id, company_id, customer_name, contact_first_name, contact_last_name, phone_number, address_1, address_2, city, state, zip_code)   VALUES(3, 1, 'AutoMotive, Inc.', 'Ambra', 'Tenney', '445-688-3778', '561 N Cedar Rock Ln', '', 'Levant', 'ME', '04456')
INSERT INTO customers (id, company_id, customer_name, contact_first_name, contact_last_name, phone_number, address_1, address_2, city, state, zip_code) VALUES (4, 1, 'McKinsey''s Auto Body Repair, LLC', 'Melissa', 'McKinsey', '884-237-6764', '790 S Summer Blvd', '', 'Seward', 'AK', '99664')
INSERT INTO customers (id, company_id, customer_name, contact_first_name, contact_last_name, phone_number, address_1, address_2, city, state, zip_code) VALUES (5, 2, 'Fonteboa & Associates, LLP', 'Milos', 'Fonteboa', '776-869-0469', '8490 NW Walnut Cv', '', 'Troy', 'MO', '63379')
INSERT INTO customers (id, company_id, customer_name, contact_first_name, contact_last_name, phone_number, address_1, address_2, city, state, zip_code) VALUES (6, 2, 'Sarullo''s Pizzeria', 'Lovette', 'Sarullo', '826-834-0749', '2840 N Canal Br', 'Suite 110', 'Lubbock', 'TX', '79412')
INSERT INTO customers (id, company_id, customer_name, contact_first_name, contact_last_name, phone_number, address_1, address_2, city, state, zip_code) VALUES (7, 3, 'Massachusetts Department of Transportation', 'Kaysi', 'Copps', '274-233-7536', '1000 NW Embleton St', 'Suite 400', 'Forestdale', 'MA', '02644')
SET IDENTITY_INSERT customers OFF
-- END customers INSERTs

-- INSERT statements to create our staff
SET IDENTITY_INSERT staff ON
INSERT INTO staff (id, company_id, first_name, last_name, employment_status, hourly_cost, standard_billable_rate, hours_per_week, resource_title, phone_number, address_1, address_2, city, state, zip_code) VALUES (1, 1, 'Braidyn', 'Armlin', 'FTE', 32.75, 95.00, 40, 'Project Manager', '625-362-3729', '3467 W Poplar St', '', 'Corona Del Mar', 'CA', '92625')
INSERT INTO staff (id, company_id, first_name, last_name, employment_status, hourly_cost, standard_billable_rate, hours_per_week, resource_title, phone_number, address_1, address_2, city, state, zip_code) VALUES (2, 1, 'Manpreet', 'Lamer', 'FTE', 30.25, 95.00, 40, 'Project Manager', '532-956-3139', '2061 NW Mahon Cir', '', 'Corona Del Mar', 'CA', '92625')
INSERT INTO staff (id, company_id, first_name, last_name, employment_status, hourly_cost, standard_billable_rate, hours_per_week, resource_title, phone_number, address_1, address_2, city, state, zip_code) VALUES (3, 1, 'Nabila', 'Sarcinelli', 'Contract', 55.00, 125.00, 32, 'Technical Consultant', '235-454-0685', '8565 SW Riverside Ct', 'Apt 1204', 'Yonkers', 'NY', '10710')
INSERT INTO staff (id, company_id, first_name, last_name, employment_status, hourly_cost, standard_billable_rate, hours_per_week, resource_title, phone_number, address_1, address_2, city, state, zip_code) VALUES (4, 1, 'Malaak', 'Salva', 'Contract', 75.00, 175.00, 20, 'Senior Database Administrator', '535-445-7057', '7353 N Wrights Rd', '', 'Eustace', 'TX', '75124')
INSERT INTO staff (id, company_id, first_name, last_name, employment_status, hourly_cost, standard_billable_rate, hours_per_week, resource_title, phone_number, address_1, address_2, city, state, zip_code) VALUES (5, 2, 'Margeurita', 'Boulier', 'FTE', 62.50, 150.00, 40, 'Director, Engineering', '858-979-2288', '2906 Longbrake Ct', '', 'Rome', 'IN', '47574')
INSERT INTO staff (id, company_id, first_name, last_name, employment_status, hourly_cost, standard_billable_rate, hours_per_week, resource_title, phone_number, address_1, address_2, city, state, zip_code) VALUES (6, 2, 'Laney', 'Puglisi', 'FTE', 50.00, 135.00, 40, 'Senior Software Engineer', '874-256-5706', '368 NE Louisiana Cv', '', 'Newell', 'WV', '26050')
INSERT INTO staff (id, company_id, first_name, last_name, employment_status, hourly_cost, standard_billable_rate, hours_per_week, resource_title, phone_number, address_1, address_2, city, state, zip_code) VALUES (7, 3, 'Rocky', 'Nutall', 'FTE', 45.00, 125.00, 40, 'Principal Consultant', '468-795-5494', '3502 NE 19th St', '', 'Mangham', 'LA', '71259')
